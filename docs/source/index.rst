...
``mne-plsc`` is a library for partial least squares correlation (PLSC) analysis of M/EEG data in Python, integrated with the MNE-Python library. It is based on the ``pyplsc`` library.
